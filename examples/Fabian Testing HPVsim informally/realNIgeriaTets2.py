...
def make_multical(name,
                     ...
                     datafiles = [],
                     verbose = True,
                     callback = None #callback function for optuna to call at the end of each trial in each calibration
                     ):
    '''
    ...
    mc = MultiCalibration(sim=sim, seeds=rss, workers=n_workers, 
                                name=name,
                                calibrate_args={'plots':["learning_curve", "timeline"], "optuna_callback":callback },
...
if __name__ == "__main__":
    ...
    name = "C:\\Users\\fabia\\Documents\\GitHub\\hpvsim\\RawTemp\\Sep2624_1"
    seeds = [20,21,22]
